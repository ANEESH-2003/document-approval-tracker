...
export default function page() {
  ...
  return (
      <div className="min-h-full">
        ...
        <p className='p-2 pt-5 font-bold text-center text-2xl'>Enter Admin Information</p>
        ...
        <div className='flex flex-col sm:flex-row justify-around mt-10'>
            <button className='mx-auto sm:w-[35%] w-[80%] bg-lime-500 p-3 rounded-2xl font-bold text-white shadow-lg transform hover:scale-105 transition duration-100 hover:text-lime-200' onclick={addbuttonclick}>Add Admin</button>
            <button className='mx-auto sm:w-[35%] w-[80%] mt-10 sm:mt-0 bg-red-500 p-3 rounded-2xl font-bold text-white shadow-lg transform hover:scale-105 transition duration-100 hover:text-red-200' onclick={removebuttonclick}>Remove Admin</button>
        </div>
        </main>
        </div>
  )
